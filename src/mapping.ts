...
const STACK_OF: Record<string, ExtMeta> = {
  ...
  'onecentlin.laravel-blade': { stack: 'php', label: 'Laravel Blade Snippets', reason: 'Blade template tooling' },
  'junstyle.php-cs-fixer': { stack: 'php', label: 'PHP CS Fixer', reason: 'PHP formatter' },
  ...
  'christian-kohler.npm-intellisense': { stack: 'node', label: 'npm Intellisense', reason: 'npm import tooling' },
  'wix.vscode-import-cost': { stack: 'node', label: 'Import Cost', reason: 'JS import size tooling' },
  'svelte.svelte-vscode': { stack: 'node', label: 'Svelte', reason: 'Svelte tooling' },
  'astro-build.astro-vscode': { stack: 'node', label: 'Astro', reason: 'Astro tooling' },
  ...
  'vadimcn.vscode-lldb': { stack: 'rust', label: 'CodeLLDB', reason: 'Native/Rust debugger' },
  'serayuzgur.crates': { stack: 'rust', label: 'crates', reason: 'Cargo dependency tooling' },
  ...
  'felixangelov.bloc': { stack: 'flutter', label: 'bloc', reason: 'Flutter state management tooling' },
  'robert-brunhage.flutter-riverpod-snippets': { stack: 'flutter', label: 'Riverpod Snippets', reason: 'Riverpod snippets' },
  'hirantha.json-to-dart': { stack: 'flutter', label: 'Json to Dart', reason: 'Dart model generator' },
  'ms-python.python': { stack: 'python', label: 'Python', reason: 'Python language tooling' },
  'ms-python.debugpy': { stack: 'python', label: 'Python Debugger', reason: 'Python debugging' },
  'ms-python.vscode-pylance': { stack: 'python', label: 'Pylance', reason: 'Python language server' },
  'ms-python.black-formatter': { stack: 'python', label: 'Black Formatter', reason: 'Python formatter' },
  'ms-python.mypy-type-checker': { stack: 'python', label: 'Mypy', reason: 'Python type checker' },
  'charliermarsh.ruff': { stack: 'python', label: 'Ruff', reason: 'Python linter/formatter' },
...
const ALWAYS_KEEP_EXACT = new Set([
  ...
  'esbenp.prettier-vscode', 'dbaeumer.vscode-eslint', 'inferrinizzard.prettier-sql-vscode',
...
const KEEP_LABEL: Record<string, string> = {
  ...
  'inferrinizzard.prettier-sql-vscode': 'Prettier SQL',
